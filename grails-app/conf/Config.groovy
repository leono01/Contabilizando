...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'com.contabilizando.login.Usuario'
...
grails.plugin.springsecurity.controllerAnnotations.staticRules = [
	...
	'/**/favicon.ico':                ['permitAll'],
        ...
        '/imagen/**':                     ['ROLE_ADMINISTRADOR','ROLE_CONTADOR'],
        ...
        '/contabilidad/**':               ['ROLE_ADMINISTRADOR','ROLE_CONTADOR'],
        '/regimenFiscal/**':              ['ROLE_ADMINISTRADOR','ROLE_CONTADOR']
