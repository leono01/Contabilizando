        ...
        <tbody>
            ...
            <tr class="info">
                    ...
                    <td><div class="fieldcontain ${hasErrors(bean: concepto, field: 'unidad', 'error')} required">
                            ...
                            <!--<g:textField name="descripcion" required="" value="${concepto?.descripcion}" size="28" style="text-align:center"/>-->
                            <g:select   id="conceptoIngreso" name="conceptoIngreso" 
                                        from="${com.contabilizando.catalogos.ConceptoIngreso.list()}" 
                                        optionKey="id" required="" value="${conceptoIngresoInstance?.id}"/>
                        </div>
                    </td>
