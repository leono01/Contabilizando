	...
	<body>
		...
		<div id="show-categoria" class="content scaffold-show" role="main">
			...
			<ol class="property-list categoria">
				...
				<g:if test="${categoriaInstance?.nombreDeCategoria}">
				<li class="fieldcontain">
					<span id="nombreDeCategoria-label" class="property-label"><g:message code="categoria.nombreDeCategoria.label" default="Nombre De Categoria" /></span>
					
						<span class="property-value" aria-labelledby="nombreDeCategoria-label"><g:fieldValue bean="${categoriaInstance}" field="nombreDeCategoria"/></span>
