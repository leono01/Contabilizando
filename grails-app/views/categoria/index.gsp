		...
		<div id="list-categoria" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="nombreDeCategoria" title="${message(code: 'categoria.nombreDeCategoria.label', default: 'Nombre De Categoria')}" />
				...
				<g:each in="${categoriaInstanceList}" status="i" var="categoriaInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${categoriaInstance.id}">${fieldValue(bean: categoriaInstance, field: "nombreDeCategoria")}</g:link></td>
