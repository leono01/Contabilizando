...
<html>
	...
	<body>
		<a href="#edit-configuracionEmpresa" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-configuracionEmpresa" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:configuracionEmpresaInstance, action:'update']" method="PUT"  enctype="multipart/form-data">
